...
UK_TARIFF_BUCKET_NAME = os.environ.get("UK_TARIFF_BUCKET_NAME")
UK_TARIFF_BUCKET_AWS_ACCESS_KEY_ID = os.environ.get(
    "UK_TARIFF_BUCKET_AWS_ACCESS_KEY_ID"
)
UK_TARIFF_BUCKET_AWS_SECRET_ACCESS_KEY = os.environ.get(
