...
UK_TAGS_CLASSIFIER_BUCKET_NAME = os.environ.get("UK_TAGS_CLASSIFIER_BUCKET_NAME")
UK_TAGS_CLASSIFIER_BUCKET_AWS_ACCESS_KEY_ID = os.environ.get(
    "UK_TAGS_CLASSIFIER_BUCKET_AWS_ACCESS_KEY_ID"
)
UK_TAGS_CLASSIFIER_BUCKET_AWS_SECRET_ACCESS_KEY = os.environ.get(
    "UK_TAGS_CLASSIFIER_BUCKET_AWS_SECRET_ACCESS_KEY"
)
