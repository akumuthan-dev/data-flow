...
DATA_STORE_UPLOADER_SENDER_HAWK_CREDENTIALS = (
    os.environ.get('DATA_STORE_UPLOADER_SENDER_HAWK_ID'),
    os.environ.get('DATA_STORE_UPLOADER_SENDER_HAWK_KEY'),
)
AIRFLOW_API_HAWK_CREDENTIALS = (DATA_STORE_UPLOADER_SENDER_HAWK_CREDENTIALS,)
