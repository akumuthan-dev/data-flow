...
def save_model(train_data_date):
    ...
    client.load_file(
        ...
        key='models/data_hub_policy_feedback_tags_classifier/' + model_version,
        bucket_name=bucket,
    )
...
def upload_training_file(file_path):
    ...
    client.load_file(
        filename=file_path,
        key='models/data_hub_policy_feedback_tags_classifier/'
        + file_path.split('/')[-1],
        bucket_name=bucket,
    )
...
# upload_training_file('/Users/linglingli/DIT/data-flow/training_data_20201127.csv')
