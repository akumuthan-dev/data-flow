...
class DataHubMonthlyInvesmentProjectsPipline(_SQLPipelineDAG):
    ...
    query = '''
    WITH
    --Table reducing to relevant time periods and adding two additional 'sector' fields
    ...
    CASE
        --Exclude projects which are not FDI
        WHEN investment_projects.investment_type != 'FDI' THEN NULL
    ...
    CASE
        --Exclude projects which are not FDI
        WHEN investment_projects.investment_type != 'FDI' THEN 'Not applicable'
