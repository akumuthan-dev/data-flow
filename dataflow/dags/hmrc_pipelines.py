...
class HMRCNonEUExports(_HMRCPipeline):
    ...
    table_config = TableConfig(
        ...
        field_mapping=[
            ...
            (19, sa.Column("nett_mass", sa.BigInteger)),
            (20, sa.Column("supp_unit", sa.BigInteger)),
...
class HMRCNonEUImports(_HMRCPipeline):
    ...
    table_config = TableConfig(
        ...
        field_mapping=[
            ...
            (12, sa.Column("country_sequence_impure", sa.String(3))),
            (13, sa.Column("country_alpha_impure", sa.String(2))),
            ...
            (24, sa.Column("nett_mass", sa.BigInteger)),
            (25, sa.Column("supp_unit", sa.BigInteger)),
...
class HMRCEUExports(_HMRCPipeline):
    ...
    table_config = TableConfig(
        ...
        field_mapping=[
            ...
            (12, sa.Column("industrial_plant_comcode", sa.String(9))),
