...
class ONSPostcodePipeline(BaseDatasetPipeline):
    ...
    field_mapping = [
        ('pcd', sa.Column('pcd', sa.String)),
        ('pcd2', sa.Column('pcd2', sa.String)),
        ('pcds', sa.Column('pcds', sa.String)),
        ('dointr', sa.Column('dointr', sa.Date)),
        ('doterm', sa.Column('doterm', sa.Date)),
        ('oscty', sa.Column('oscty', sa.String)),
        ('ced', sa.Column('ced', sa.String)),
        ('oslaua', sa.Column('oslaua', sa.String)),
        ('osward', sa.Column('osward', sa.String)),
        ('parish', sa.Column('parish', sa.String)),
        ('usertype', sa.Column('usertype', sa.String)),
        ('oseast1m', sa.Column('oseast1m', sa.String)),
        ('osnrth1m', sa.Column('osnrth1m', sa.String)),
        ('osgrdind', sa.Column('osgrdind', sa.String)),
        ('oshlthau', sa.Column('oshlthau', sa.String)),
        ('nhser', sa.Column('nhser', sa.String)),
        ('ctry', sa.Column('ctry', sa.String)),
        ('rgn', sa.Column('rgn', sa.String)),
        ('streg', sa.Column('streg', sa.String)),
        ('pcon', sa.Column('pcon', sa.String)),
        ('eer', sa.Column('eer', sa.String)),
        ('teclec', sa.Column('teclec', sa.String)),
        ('ttwa', sa.Column('ttwa', sa.String)),
        ('pct', sa.Column('pct', sa.String)),
        ('nuts', sa.Column('nuts', sa.String)),
        ('statsward', sa.Column('statsward', sa.String)),
        ('oa01', sa.Column('oa01', sa.String)),
        ('casward', sa.Column('casward', sa.String)),
        ('park', sa.Column('park', sa.String)),
        ('lsoa01', sa.Column('lsoa01', sa.String)),
        ('msoa01', sa.Column('msoa01', sa.String)),
        ('ur01ind', sa.Column('ur01ind', sa.String)),
        ('oac01', sa.Column('oac01', sa.String)),
        ('oa11', sa.Column('oa11', sa.String)),
        ('lsoa11', sa.Column('lsoa11', sa.String)),
        ('msoa11', sa.Column('msoa11', sa.String)),
        ('wz11', sa.Column('wz11', sa.String)),
        ('ccg', sa.Column('ccg', sa.String)),
        ('bua11', sa.Column('bua11', sa.String)),
        ('buasd11', sa.Column('buasd11', sa.String)),
        ('ru11ind', sa.Column('ru11ind', sa.String)),
        ('oac11', sa.Column('oac11', sa.String)),
        ('lat', sa.Column('lat', sa.String)),
        ('long', sa.Column('long', sa.String)),
        ('lep1', sa.Column('lep1', sa.String)),
        ('lep2', sa.Column('lep2', sa.String)),
        ('pfa', sa.Column('pfa', sa.String)),
        ('imd', sa.Column('imd', sa.String)),
        ('calncv', sa.Column('calncv', sa.String)),
        ('stp', sa.Column('stp', sa.String)),
    ]
