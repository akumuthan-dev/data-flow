...
# On deployment to PaaS, this variable get dynamically generated by usign VCAP_SERVICES. It pickes up the first database defined.
# Please only bind one database to the app on PaaS.
