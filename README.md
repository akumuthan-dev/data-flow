...
- Create a postgres role for your user
...
- If fields attribute of ViewPipeline is set to __all__, the view will be created by using all the fields of regarding dataset. Use this when you want to include all fields in dataset without using alias.
